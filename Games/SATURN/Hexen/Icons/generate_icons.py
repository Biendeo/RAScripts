...
SINGLE_LAYER_ACHIEVEMENTS = [
    ...
    "Item-SilentRefectory-BanishmentDevice",
    "Item-SilentRefectory-SapphirePlanet",
    "Item-SilentRefectory-RubyPlanet",
    "Item-SilentRefectory-Porkalator",
    "Item-SilentRefectory-EmeraldPlanet",
